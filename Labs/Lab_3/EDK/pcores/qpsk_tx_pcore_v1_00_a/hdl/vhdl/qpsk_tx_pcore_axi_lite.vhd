-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\Labs\Lab_3\MATLAB\codegen\qpsk_tx\hdlsrc\qpsk_tx_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qpsk_tx_pcore_axi_lite
-- Source Path: qpsk_tx_pcore/qpsk_tx_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qpsk_tx_pcore_axi_lite IS
...
END qpsk_tx_pcore_axi_lite;


ARCHITECTURE rtl OF qpsk_tx_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT qpsk_tx_pcore_addr_decoder
  ...
  COMPONENT qpsk_tx_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : qpsk_tx_pcore_addr_decoder
    USE ENTITY work.qpsk_tx_pcore_addr_decoder(rtl);

  FOR ALL : qpsk_tx_pcore_axi_lite_module
    USE ENTITY work.qpsk_tx_pcore_axi_lite_module(rtl);
  ...
  SIGNAL inst_clear_fifo_in               : std_logic;  -- ufix1
  SIGNAL inst_tx_en_in                    : std_logic;  -- ufix1
...
BEGIN
  u_qpsk_tx_pcore_addr_decoder_inst : qpsk_tx_pcore_addr_decoder
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
              ...
              read_tx_done_out => read_tx_done_out,  -- ufix1
              data_read => top_data_read,  -- ufix32
              write_axi_enable => inst_axi_enable,  -- ufix1
              write_clear_fifo_in => inst_clear_fifo_in,  -- ufix1
              write_tx_en_in => inst_tx_en_in  -- ufix1
              );

  u_qpsk_tx_pcore_axi_lite_module_inst : qpsk_tx_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
  ...
  write_clear_fifo_in <= inst_clear_fifo_in;

  write_tx_en_in <= inst_tx_en_in;
