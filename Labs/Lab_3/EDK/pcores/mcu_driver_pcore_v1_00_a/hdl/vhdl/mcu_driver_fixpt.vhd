-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\pcore_Branch\Chilipepper\Labs\Lab_3\MATLAB\codegen\mcu_driver\hdlsrc\mcu_driver_fixpt.vhd
-- Created: 2013-11-15 16:37:33
-- 
...
ARCHITECTURE rtl OF mcu_driver_fixpt IS
  ...
  SIGNAL tmp_32                           : unsigned(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL p52blinky_mul_temp               : unsigned(38 DOWNTO 0);  -- ufix39_En37
  SIGNAL p52blinky_cast                   : unsigned(1 DOWNTO 0);  -- ufix2
...
BEGIN
  ...
  tmp_1 <= reset_not_empty;

  
  tmp_2 <= '1' WHEN (( NOT tmp_1) OR mcu_reg_reset) = '1' ELSE
      reset_not_empty;
  ...
  tmp_6 <= '1' WHEN (( NOT tmp_4) OR mcu_reg_reset) = '1' ELSE
      reset_1;

  
  tmp_7 <= tmp WHEN latch = '1' ELSE
      tmp_6;
  ...
  tmp_11 <= '0' WHEN (( NOT tmp_9) OR mcu_reg_reset) = '1' ELSE
      tr_switch;

  
  tmp_12 <= tmp_8 WHEN latch = '1' ELSE
      tmp_11;
  ...
  tmp_16 <= '0' WHEN (( NOT tmp_14) OR mcu_reg_reset) = '1' ELSE
      pa_enable;

  
  tmp_17 <= tmp_13 WHEN latch = '1' ELSE
      tmp_16;
  ...
  tmp_21 <= '0' WHEN (( NOT tmp_19) OR mcu_reg_reset) = '1' ELSE
      tx_enable;

  
  tmp_22 <= tmp_18 WHEN latch = '1' ELSE
      tmp_21;
  ...
  tmp_26 <= '0' WHEN (( NOT tmp_24) OR mcu_reg_reset) = '1' ELSE
      rx_enable;

  
  tmp_27 <= tmp_23 WHEN latch = '1' ELSE
      tmp_26;
  ...
  tmp_30 <= '1' WHEN (( NOT tmp_29) OR mcu_reg_reset) = '1' ELSE
      reg_reset_done_1;

  reg_reset_done_2 <= tmp_30;

  reg_reset_done <= reg_reset_done_2;

  tmp_31 <= reset_not_empty;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        blinky_cnt_reg_blinky_cnt <= tmp_32;
      END IF;
    END IF;
  ...
  tmp_33 <= to_unsigned(2#0000000000000000000000000#, 25) WHEN (( NOT tmp_31) OR mcu_reg_reset) = '1' ELSE
      blinky_cnt;

  blinky_cnt_1 <= tmp_33 + 1;

  
  tmp_32 <= to_unsigned(2#0000000000000000000000000#, 25) WHEN blinky_cnt_1 = 20000000 ELSE
      blinky_cnt_1;

  p52blinky_mul_temp <= tmp_32 * to_unsigned(2#11010110101111#, 14);
  p52blinky_cast <= p52blinky_mul_temp(38 DOWNTO 37);
  blinky_1 <= p52blinky_cast(0);
