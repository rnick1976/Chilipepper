-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\Labs\Lab_1\MATLAB\codegen\output_tone\hdlsrc\tone_generator_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tone_generator_pcore_axi_lite
-- Source Path: tone_generator_pcore/tone_generator_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tone_generator_pcore_axi_lite IS
...
END tone_generator_pcore_axi_lite;


ARCHITECTURE rtl OF tone_generator_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT tone_generator_pcore_addr_decoder
  ...
  COMPONENT tone_generator_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : tone_generator_pcore_addr_decoder
    USE ENTITY work.tone_generator_pcore_addr_decoder(rtl);

  FOR ALL : tone_generator_pcore_axi_lite_module
    USE ENTITY work.tone_generator_pcore_axi_lite_module(rtl);
...
BEGIN
  u_tone_generator_pcore_addr_decoder_inst : tone_generator_pcore_addr_decoder
  ...
  u_tone_generator_pcore_axi_lite_module_inst : tone_generator_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
