-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\Labs\Lab_0\MATLAB\codegen\blink_leds\hdlsrc\blink_leds_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: blink_leds_pcore_axi_lite
-- Source Path: blink_leds_pcore/blink_leds_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY blink_leds_pcore_axi_lite IS
...
END blink_leds_pcore_axi_lite;


ARCHITECTURE rtl OF blink_leds_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT blink_leds_pcore_addr_decoder
  ...
  COMPONENT blink_leds_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : blink_leds_pcore_addr_decoder
    USE ENTITY work.blink_leds_pcore_addr_decoder(rtl);

  FOR ALL : blink_leds_pcore_axi_lite_module
    USE ENTITY work.blink_leds_pcore_axi_lite_module(rtl);
...
BEGIN
  u_blink_leds_pcore_addr_decoder_inst : blink_leds_pcore_addr_decoder
  ...
  u_blink_leds_pcore_axi_lite_module_inst : blink_leds_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
