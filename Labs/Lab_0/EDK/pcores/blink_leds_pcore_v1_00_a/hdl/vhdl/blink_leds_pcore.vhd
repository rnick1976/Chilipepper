-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\Labs\Lab_0\MATLAB\codegen\blink_leds\hdlsrc\blink_leds_pcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: blink_leds_pcore
-- Source Path: blink_leds_pcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END blink_leds_pcore;


ARCHITECTURE rtl OF blink_leds_pcore IS

  -- Component Declarations
  COMPONENT blink_leds_pcore_axi_lite
  ...
  COMPONENT blink_leds_pcore_dut
  ...
  FOR ALL : blink_leds_pcore_axi_lite
    USE ENTITY work.blink_leds_pcore_axi_lite(rtl);

  FOR ALL : blink_leds_pcore_dut
    USE ENTITY work.blink_leds_pcore_dut(rtl);
...
BEGIN
  u_blink_leds_pcore_axi_lite_inst : blink_leds_pcore_axi_lite
  ...
  u_blink_leds_pcore_dut_inst : blink_leds_pcore_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              dummy_input => dummy_input,  -- ufix1
