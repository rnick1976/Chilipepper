-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\Labs\Lab_0\MATLAB\codegen\blink_leds\hdlsrc\blink_leds_pcore_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: blink_leds_pcore_addr_decoder
-- Source Path: blink_leds_pcore/blink_leds_pcore_axi_lite/blink_leds_pcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY blink_leds_pcore_addr_decoder IS
...
END blink_leds_pcore_addr_decoder;


ARCHITECTURE rtl OF blink_leds_pcore_addr_decoder IS
