-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\QPSK_Radio\MATLAB\codegen\qpsk_rx\hdlsrc\qpsk_rx_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: qpsk_rx_pcore_axi_lite
-- Source Path: qpsk_rx_pcore/qpsk_rx_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY qpsk_rx_pcore_axi_lite IS
...
END qpsk_rx_pcore_axi_lite;


ARCHITECTURE rtl OF qpsk_rx_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT qpsk_rx_pcore_addr_decoder
  ...
  COMPONENT qpsk_rx_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : qpsk_rx_pcore_addr_decoder
    USE ENTITY work.qpsk_rx_pcore_addr_decoder(rtl);

  FOR ALL : qpsk_rx_pcore_axi_lite_module
    USE ENTITY work.qpsk_rx_pcore_axi_lite_module(rtl);
  ...
  SIGNAL inst_mcu_rx_ready_in             : std_logic;  -- ufix1
...
BEGIN
  u_qpsk_rx_pcore_addr_decoder_inst : qpsk_rx_pcore_addr_decoder
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
              ...
              read_num_bytes_ready => read_num_bytes_ready,  -- ufix5
              data_read => top_data_read,  -- ufix32
              write_axi_enable => inst_axi_enable,  -- ufix1
              write_mcu_rx_ready_in => inst_mcu_rx_ready_in  -- ufix1
              );

  u_qpsk_rx_pcore_axi_lite_module_inst : qpsk_rx_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
  ...
  write_mcu_rx_ready_in <= inst_mcu_rx_ready_in;
