-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\QPSK_Radio\MATLAB\codegen\adc_driver\hdlsrc\adc_driver_pcore_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: adc_driver_pcore_addr_decoder
-- Source Path: adc_driver_pcore/adc_driver_pcore_axi_lite/adc_driver_pcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY adc_driver_pcore_addr_decoder IS
...
END adc_driver_pcore_addr_decoder;


ARCHITECTURE rtl OF adc_driver_pcore_addr_decoder IS
