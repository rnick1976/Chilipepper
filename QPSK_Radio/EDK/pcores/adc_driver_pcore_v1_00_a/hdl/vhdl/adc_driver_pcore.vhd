-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\QPSK_Radio\MATLAB\codegen\adc_driver\hdlsrc\adc_driver_pcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: adc_driver_pcore
-- Source Path: adc_driver_pcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY adc_driver_pcore IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        rxd                               :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
        ...
        rx_i                              :   OUT   std_logic_vector(11 DOWNTO 0);  -- ufix12
        rx_q                              :   OUT   std_logic_vector(11 DOWNTO 0);  -- ufix12
...
END adc_driver_pcore;


ARCHITECTURE rtl OF adc_driver_pcore IS

  -- Component Declarations
  COMPONENT adc_driver_pcore_axi_lite
  ...
  COMPONENT adc_driver_pcore_dut
  ...
  FOR ALL : adc_driver_pcore_axi_lite
    USE ENTITY work.adc_driver_pcore_axi_lite(rtl);

  FOR ALL : adc_driver_pcore_dut
    USE ENTITY work.adc_driver_pcore_dut(rtl);
...
BEGIN
  u_adc_driver_pcore_axi_lite_inst : adc_driver_pcore_axi_lite
  ...
  u_adc_driver_pcore_dut_inst : adc_driver_pcore_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              rxd => rxd,  -- sfix12
              rx_iq_sel => rx_iq_sel,  -- ufix1
