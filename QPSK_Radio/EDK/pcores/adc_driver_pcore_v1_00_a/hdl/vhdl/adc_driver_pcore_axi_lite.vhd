-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\QPSK_Pcore\QPSK_Radio\MATLAB\codegen\adc_driver\hdlsrc\adc_driver_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: adc_driver_pcore_axi_lite
-- Source Path: adc_driver_pcore/adc_driver_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY adc_driver_pcore_axi_lite IS
...
END adc_driver_pcore_axi_lite;


ARCHITECTURE rtl OF adc_driver_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT adc_driver_pcore_addr_decoder
  ...
  COMPONENT adc_driver_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : adc_driver_pcore_addr_decoder
    USE ENTITY work.adc_driver_pcore_addr_decoder(rtl);

  FOR ALL : adc_driver_pcore_axi_lite_module
    USE ENTITY work.adc_driver_pcore_axi_lite_module(rtl);
...
BEGIN
  u_adc_driver_pcore_addr_decoder_inst : adc_driver_pcore_addr_decoder
  ...
  u_adc_driver_pcore_axi_lite_module_inst : adc_driver_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
