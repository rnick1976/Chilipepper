-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\pcore_Examples\FIFO_DEMO\MATLAB\codegen\tx_fifo\hdlsrc\tx_fifo_pcore_axi_lite.vhd
...
ARCHITECTURE rtl OF tx_fifo_pcore_axi_lite IS
  ...
  SIGNAL inst_byte_in                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL inst_reset_fifo                  : std_logic;  -- ufix1
  SIGNAL inst_fifo_enable                 : std_logic;  -- ufix1
...
BEGIN
  u_tx_fifo_pcore_addr_decoder_inst : tx_fifo_pcore_addr_decoder
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
              ...
              read_empty => read_empty,  -- ufix1
              read_byte_received => read_byte_received,  -- ufix1
              read_full => read_full,  -- ufix1
              read_bytes_available => read_bytes_available,  -- ufix32
              ...
              write_byte_in => inst_byte_in,  -- ufix32
              write_reset_fifo => inst_reset_fifo,  -- ufix1
              write_fifo_enable => inst_fifo_enable  -- ufix1
              );
  ...
  write_fifo_enable <= inst_fifo_enable;
