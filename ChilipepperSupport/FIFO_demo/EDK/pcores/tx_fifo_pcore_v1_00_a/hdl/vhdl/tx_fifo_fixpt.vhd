-- -------------------------------------------------------------
-- 
-- File Name: C:\GIT\pcore_Examples\FIFO_DEMO\MATLAB\codegen\tx_fifo\hdlsrc\tx_fifo_fixpt.vhd
...
USE work.tx_fifo_fixpt_pkg.ALL;
...
ARCHITECTURE rtl OF tx_fifo_fixpt IS
  ...
  SIGNAL p15_tmp                          : std_logic;  -- ufix1
  ...
  SIGNAL tmp_27                           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL tmp_28                           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL tmp_29                           : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL dbg_fifo_enable_1                : std_logic;  -- ufix1
  SIGNAL dbg_fifo_enable_2                : std_logic;  -- ufix1
...
BEGIN
  ...
  p15_tmp <= '1' WHEN ((store_byte /= '0') AND ( NOT (tmp_8 /= '0'))) AND (tmp_9 = '0') ELSE
      tmp_9;
  
  tmp_10 <= p15_tmp WHEN fifo_enable = '1' ELSE
      tmp_9;
  ...
  tmp_12 <= '0' WHEN (reset_fifo OR ( NOT tmp_5)) = '1' ELSE
      handshake;

  
  tmp_9 <= '0' WHEN store_byte = '0' ELSE
      tmp_12;

  head <= tmp_13 + 1;

  
  tmp_14 <= to_unsigned(2#00000000001#, 11) WHEN head = 1025 ELSE
      head;

  
  p17_tmp <= tmp_14 WHEN (get_byte /= '0') AND ( NOT (tmp_15 /= '0')) ELSE
      tmp_13;
  
  tmp_16 <= p17_tmp WHEN fifo_enable = '1' ELSE
      tmp_13;
  ...
  tmp_13 <= to_unsigned(2#00000000001#, 11) WHEN (reset_fifo OR ( NOT tmp_4)) = '1' ELSE
      head_1;

  
  tmp_8 <= '1' WHEN ((tmp_13 = 1) AND (tmp_6 = 1024)) OR ((resize(tmp_6, 12) + 1) = resize(tmp_13, 12)) ELSE
      full_1;

  
  p21_tmp <= tmp_7 WHEN ((store_byte /= '0') AND ( NOT (tmp_8 /= '0'))) AND (tmp_9 = '0') ELSE
      tmp_6;
  ...
  tmp_15 <= '1' WHEN ((tmp_6 = 1) AND (tmp_13 = 1024)) OR ((resize(tmp_13, 12) + 1) = resize(tmp_6, 12)) ELSE
      empty_1;
  ...
  tmp_19 <= byte_in_unsigned(7 DOWNTO 0);

  p31tmp_sub_cast <= signed(resize(tmp_6, 32));
  tmp_20 <= p31tmp_sub_cast - 1;

  p12_output : PROCESS (fifo_enable, store_byte, tmp_8, tmp_9, fifo, tmp_19, tmp_20)
  BEGIN
    IF fifo_enable = '1' THEN 
      IF ((store_byte /= '0') AND ( NOT (tmp_8 /= '0'))) AND (tmp_9 = '0') THEN 
        tmp_21 <= fifo;
  ...
  p19_sub_cast <= signed(resize(tmp_14, 32));
  
  p19_tmp <= fifo(to_integer(p19_sub_cast - 1)) WHEN (get_byte /= '0') AND ( NOT (tmp_15 /= '0')) ELSE
      tmp_23;
  
  tmp_22 <= p19_tmp WHEN fifo_enable = '1' ELSE
      tmp_23;

  dout <= std_logic_vector(tmp_22);
  ...
  tmp_24 <= '1' WHEN tmp_9 = '1' ELSE
      byte_received_1;

  
  p13_tmp <= '1' WHEN ((store_byte /= '0') AND ( NOT (tmp_8 /= '0'))) AND (tmp_9 = '0') ELSE
      tmp_24;
  
  tmp_25 <= p13_tmp WHEN fifo_enable = '1' ELSE
      tmp_24;

  byte_received_2 <= tmp_25;

  byte_received <= byte_received_2;
  ...
  tmp_27 <= resize(resize(resize(1024 - resize(tmp_16, 12), 13) + resize(tmp_17, 13), 14) - 1, 32);

  tmp_28 <= resize(resize(resize(tmp_17, 12) - resize(tmp_16, 12), 13) - 1, 32);
  ...
  dbg_fifo_enable_1 <= fifo_enable;

  dbg_fifo_enable_2 <= dbg_fifo_enable_1;

  dbg_fifo_enable <= dbg_fifo_enable_2;
